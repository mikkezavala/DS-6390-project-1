        ...
        <Row gutter={16}>
            <Col span={8}>
                <Card variant="borderless">
                    <Card.Meta avatar={<Avatar src="/src/assets/mz.png"/>} title="Miguel Zavala"/>
                    <p>
            ...
            <Col span={8}>
                <Card variant="borderless">
                    <Card.Meta avatar={<Avatar src="/src/assets/bb.png"/>} title="Brittany Blackmon"/>
                    <p>
            ...
            <Col span={8}>
                <Card variant="borderless">
                    <Card.Meta avatar={<Avatar src="/src/assets/ba.png"/>} title="Blake Armstrong"/>
                    <p>
